        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <div className="max-w-4xl mx-auto mb-6 sm:mb-8">
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 leading-relaxed">
              <span className="font-semibold text-gray-800">{t('videoAbout.subtitle.start')}</span> {t('videoAbout.subtitle.end')}
            </p>
          </div>
        </div>
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div>
              <div className="flex items-center mb-3 sm:mb-4">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900">{t('videoAbout.mission.title')}</h3>
              </div>
            ...
            <div>
              <div className="flex items-center mb-3 sm:mb-4">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900">{t('videoAbout.results.title')}</h3>
              </div>
            ...
            <div>
              <div className="flex items-center mb-3 sm:mb-4">
                <div className="w-1 h-6 sm:h-8 bg-brand-blue rounded-full mr-3 sm:mr-4"></div>
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900">{t('videoAbout.pioneers.title')}</h3>
              </div>
              <p className="text-gray-600 leading-relaxed pl-4 sm:pl-6 text-base sm:text-lg">
