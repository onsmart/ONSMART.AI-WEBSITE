  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <section className="relative py-12 md:py-16 overflow-hidden hero-pattern-bg -mt-8">
        ...
        <div className="absolute -top-20 -right-20 w-64 h-64 bg-indigo-500/20 rounded-full blur-blob animate-pulse-slow"></div>
        <div className="absolute -bottom-10 -left-10 w-48 h-48 bg-indigo-400/30 rounded-full blur-blob animate-pulse-slow"></div>
        ...
        <div className="container mx-auto max-w-5xl px-4 md:px-6 relative z-20">
          <div className="text-center animate-fade-in max-w-3xl mx-auto">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <Badge variant="outline" className="bg-indigo-500/10 text-indigo-500 border-indigo-500/20">Voz & Linguagem</Badge>
            </div>
            <h1 className="text-3xl md:text-5xl font-bold mb-6 text-white leading-tight drop-shadow-lg">NLP Especializado em Português</h1>
            <p className="text-lg md:text-xl text-gray-100 max-w-2xl mx-auto mb-8 leading-relaxed drop-shadow-md">Domine a comunicação por voz com IA especializada em português brasileiro, interfaces conversacionais e transcrição inteligente</p>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Como Funciona Nossa Tecnologia de Voz</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">Nossa IA é 100% otimizada para português brasileiro, compreendendo sotaques, expressões regionais e contextos culturais</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((feature, index) => {
              const IconComponent = feature.icon;
              return (
                <Card key={index} className="hover:shadow-lg transition-all duration-300 border-2 hover:border-indigo-500/20">
                  <CardHeader>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Veja como nossa tecnologia de voz e linguagem pode ser aplicada em diferentes cenários empresariais</p>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-indigo-500/5 to-indigo-500/10 p-8 rounded-2xl">
              <div className="text-center">
                <Shield className="h-12 w-12 text-indigo-500 mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-gray-900 mb-4">100% Brasileiro</h3>
                <p className="text-gray-600 mb-6">Nossa tecnologia é desenvolvida especificamente para o português brasileiro, compreendendo todas as nuances culturais.</p>
                <div className="text-2xl font-bold text-indigo-500 mb-2">PT-BR</div>
                <div className="text-sm text-gray-600">Nativo</div>
              </div>
            </div>
          </div>
        </div>
