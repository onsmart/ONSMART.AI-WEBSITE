...
export default function MarketingLogin() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 bg-gradient-to-br from-slate-50 via-brand-blue/5 to-blue-50/30 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      ...
      <Card className="w-full max-w-md relative rounded-2xl border border-gray-200/80 dark:border-gray-700/80 shadow-2xl shadow-gray-200/30 dark:shadow-none bg-white dark:bg-gray-800 overflow-hidden">
        ...
        <CardContent className="pt-4 pb-6 sm:pb-8 px-6 sm:px-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full rounded-xl bg-brand-blue hover:bg-brand-blue/90 text-white font-medium shadow-md hover:shadow-lg transition-all h-11"
              disabled={loading}
            >
              {loading ? (
                <>
