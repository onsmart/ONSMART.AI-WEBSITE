      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Certificações e Conformidade</h2>
          ...
          <div className="flex flex-col lg:flex-row items-start justify-center gap-12 max-w-6xl mx-auto">
            ...
            <div className="lg:w-1/2 space-y-8">
              ...
              <div className="space-y-4">
                <div className="mb-4 ml-6">
                  <h4 className="text-lg font-semibold text-gray-800">AI Productivity</h4>
                  <p className="text-sm text-gray-600">Reinvente a forma de trabalhar com assistentes de IA.</p>
                </div>
                
                {/* AI Assistants */}
                <div className="ml-6 space-y-3">
                  <h5 className="text-md font-medium text-gray-700">AI Assistants</h5>
                  ...
                  <Card className="hover:shadow-lg transition-shadow">
                    <CardHeader className="pb-4">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          <CardTitle className="text-xl">watsonx Code Assistant™</CardTitle>
            ...
            <div className="lg:w-1/2 space-y-6">
              ...
              {/* IBM Certifications */}
              <div className="mb-6">
                <h4 className="text-lg font-semibold text-gray-800 mb-2">IBM Professional Certifications</h4>
                    ...
                    <CardHeader className="pb-4">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div className="flex-1">
                          <CardTitle className="text-lg">IBM watsonx Orchestrate Build an AI Assistant</CardTitle>
                          <CardDescription>Certificação oficial para construção de assistentes de IA com watsonx</CardDescription>
                        </div>
                      </div>
                    </CardHeader>
                  </Card>
