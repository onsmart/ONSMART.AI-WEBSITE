...
export default function Streamsets() {
  ...
  // Contadores animados
  const connectorsCount = useCountUp(100, 1500);
  const speedCount = useCountUp(10, 2000);
  const availabilityCount = useCountUp(99, 1800);

  // Contadores para seção adicional
  const pipelinesCount = useCountUp(5000, 2500);
  const enterpriseCount = useCountUp(400, 2200);
  const throughputCount = useCountUp(100, 2000);
