...
export default function GuardiumDataSecurityCenter() {
  ...
  const { t } = useTranslation(["guardiumDataSecurityCenter", "produtos", "common"]);
  ...
  // Contadores animados
  const coverageCount = useCountUp(100, 1500);
  const monitoringCount = useCountUp(24, 2000);
  const complianceCount = useCountUp(50, 1800);

  // Contadores para seção adicional
  const threatsCount = useCountUp(1000, 2500);
  const enterpriseCount = useCountUp(500, 2200);
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                <div className="text-center" ref={coverageCount.ref}>
              ...
              >
                ...
                {t('guardiumDataSecurityCenter:cta.requestDemo')}
              </Button>
            </div>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-blue-50 to-purple-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center bg-white rounded-xl p-8 shadow-lg" ref={threatsCount.ref}>
