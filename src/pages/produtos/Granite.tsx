...
export default function Granite() {
  ...
  const speedCount = useCountUp(50, 2000);
  const securityCount = useCountUp(100, 1800);
  const modelsCount = useCountUp(1000, 2500);
  const accuracyCount = useCountUp(98, 2000);
