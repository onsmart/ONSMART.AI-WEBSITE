...
app.post('/api/openai-format-html', async (req, res) => {
  try {
    ...
    const systemPrompt = `Você é um editor que transforma texto em HTML para artigos de site. O resultado deve ser profissional: use HTML semântico E CSS inline (atributo style) em títulos e parágrafos para hierarquia visual, espaçamento e tipografia.
...
4. LISTAS: <ul><li>...</li></ul> ou <ol><li>...</li></ul>. Pode usar style nos ul/ol/li para margin e padding se quiser.
